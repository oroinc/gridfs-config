...
/*
 * This file is a copy of {@see MongoDB\GridFS\ReadableStream}
 *
 ...
 * This class uses Oro\Bundle\GridFSConfigBundle\GridFS\CollectionWrapper.
 *
 * @internal
 */
    ...
    public function seek($offset)
    {
        if ($offset < 0 || $offset > $this->file->length) {
            throw new InvalidArgumentException(
                sprintf('$offset must be >= 0 and <= %d; given: %d', $this->file->length, $offset)
            );
        }
